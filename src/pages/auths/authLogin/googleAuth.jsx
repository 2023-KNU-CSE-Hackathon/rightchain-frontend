...
const KakaoLogin = () => {
  ...
  const GOOGLE_AUTH_URI = `https://kauth.kakao.com/oauth/authorize?client_id=${CLIENT_ID}&redirect_uri=${REDIRECT_URI}&response_type=code`;
  ...
  return (
    <>
      <div className="KaKaoBtn">
        <a href={GOOGLE_AUTH_URI}>구글로 시작하기</a>
      </div>
    </>
  );
};
